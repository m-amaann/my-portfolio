...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      > 
        <div className="bg-[#f5f9ff] absolute top-[-6rem] -z-10 right-[10rem] h-[40rem] w-[32rem] rounded-full blur-[12rem] sm:w-[70rem] dark:bg-[#263347]"></div>
        <div className="bg-[#cde1fb] absolute top-[-1rem] -z-10 left-[-30rem] h-[40rem] w-[55rem] rounded-full blur-[10rem] sm:w-[70rem] md:left-[-30rem] lg:left-[-25rem] xl:left-[-12rem] 2xl:left-[-2rem] dark:bg-[#263347]"></div>
        <ScrollProvider>
          <ThemeProvider
            attribute="class"
            defaultTheme="system"
