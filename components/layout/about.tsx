...
export default function About() {
  ...
  return (
    <motion.section
      ref={ref}
      className="mb-24 mt-8 text-center leading-8 sm:mb-40 scroll-mt-28 px-4 md:px-8 lg:px-0 justify-center"
    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start justify-center lg:mx-28 md:mx-24 mx-2">
        
        {/* Image Section (visible on mobile and hidden on md, lg, xl) */}
        <div className="hidden md:hidden w-full">
          <div className="w-full aspect-w-1 aspect-h-1 rounded-2xl bg-gradient-to-br from-transparent via-[#c9e3f9] to-transparent grid place-items-center pt-4 overflow-hidden">
            <Image
              className="rounded-2xl transition-all duration-400 ease-in-out hover:scale-110"
        ...
        {/* Text Section */}
        <div className="text-white md:px-6 lg:px-8 flex flex-col justify-start">
          <p className="mt-6 text-gray-600 leading-relaxed pb-4 text-base text-justify">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
            ...
            <article className="dark:bg-[#0458AC] bg-[#c9e3f9] border border-transparent rounded-xl p-4 text-center transition-all duration-400 ease-in-out hover:bg-transparent hover:border-blue-400">
              ...
              <div className="text-xs text-gray-400">
                3.8/4.2 <br />First Class Honours
              </div>
            </article>
